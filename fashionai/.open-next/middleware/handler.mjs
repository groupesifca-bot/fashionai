...
Object.defineProperty = function(o, p, a) {
  ...
  globalThis.openNextDebug = false;globalThis.openNextVersion = "4.1.4";globalThis.nextVersion = "15.2.1";
    ...
    (self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[550], { 35: (e, t) => {
      ...
      (() => {
        var i = { 226: function(i2, a2) {
          !function(o2, s) {
            "use strict";
            var l = "function", u = "undefined", c = "object", d = "string", p = "major", h = "model", g = "name", f = "type", b = "vendor", v = "version", m = "architecture", _ = "console", w = "mobile", y = "tablet", x = "smarttv", E = "wearable", O = "embedded", S = "Amazon", R = "Apple", C = "ASUS", P = "BlackBerry", T = "Browser", N = "Chrome", I = "Firefox", M = "Google", A = "Huawei", k = "Microsoft", j = "Motorola", L = "Opera", D = "Samsung", q = "Sharp", U = "Sony", B = "Xiaomi", V = "Zebra", $ = "Facebook", G = "Chromium OS", H = "Mac OS", W = function(e2, t2) {
              var r2 = {};
            ...
            ee.VERSION = "1.0.35", ee.BROWSER = X([g, v, p]), ee.CPU = X([m]), ee.DEVICE = X([h, b, f, _, w, x, y, E, O]), ee.ENGINE = ee.OS = X([g, v]), typeof a2 !== u ? (i2.exports && (a2 = i2.exports = ee), a2.UAParser = ee) : r.amdO ? void 0 !== (n = function() {
              return ee;
  ...
  `);
      ...
      class k {
        ...
        analyze() {
          ...
          }(null == (t2 = this[A].options.nextConfig) ? void 0 : null == (e10 = t2.i18n) ? void 0 : e10.domains, o2);
          let s2 = (null == (r2 = this[A].domainLocale) ? void 0 : r2.defaultLocale) || (null == (i2 = this[A].options.nextConfig) ? void 0 : null == (n2 = i2.i18n) ? void 0 : n2.defaultLocale);
        ...
        formatPathname() {
          ...
          }((e10 = { basePath: this[A].basePath, buildId: this[A].buildId, defaultLocale: this[A].options.forceLocale ? void 0 : this[A].defaultLocale, locale: this[A].locale, pathname: this[A].url.pathname, trailingSlash: this[A].trailingSlash }).pathname, e10.locale, e10.buildId ? void 0 : e10.defaultLocale, e10.ignorePrefix), (e10.buildId || !e10.trailingSlash) && (t2 = O(t2)), e10.buildId && (t2 = C(R(t2, "/_next/data/" + e10.buildId), "/" === e10.pathname ? "index.json" : ".json")), t2 = R(t2, e10.basePath), !e10.buildId && e10.trailingSlash ? t2.endsWith("/") ? t2 : C(t2, "/") : O(t2);
        }
        formatSearch() {
        ...
        set locale(e10) {
          var t2, r2;
          if (!this[A].locale || !(null == (r2 = this[A].options.nextConfig) ? void 0 : null == (t2 = r2.i18n) ? void 0 : t2.locales.includes(e10))) throw Object.defineProperty(TypeError(`The NextURL configuration includes no locale "${e10}"`), "__NEXT_ERROR_CODE", { value: "E597", enumerable: false, configurable: true });
          this[A].locale = e10;
        }
        get defaultLocale() {
      ...
      class D extends Request {
        constructor(e10, t2 = {}) {
          ...
          let n2 = new k(r2, { headers: v(this.headers), nextConfig: t2.nextConfig });
      ...
      class $ extends Response {
        constructor(e10, t2 = {}) {
          ...
          this[U] = { cookies: n2, url: t2.url ? new k(t2.url, { headers: v(r2), nextConfig: t2.nextConfig }) : void 0 };
        }
        [Symbol.for("edge-runtime.inspect.custom")]() {
      ...
      let H = "Next-Router-Prefetch", W = ["RSC", "Next-Router-State-Tree", H, "Next-HMR-Refresh", "Next-Router-Segment-Prefetch"], X = "_rsc";
      ...
      }, eT = /* @__PURE__ */ new Map(), eN = n.createContextKey("next.rootSpanId"), eI = 0, eM = () => eI++, eA = { set(e10, t2, r2) {
      ...
      let ez = "undefined" != typeof globalThis && globalThis.AsyncLocalStorage, eF = ez ? new ez() : new eX();
      class eK {
      ...
      async function e4(e10) {
        ...
        if (n2 && b2 && (d2 || !a2)) {
          let t3 = new k(b2, { forceLocale: true, headers: e10.request.headers, nextConfig: e10.request.nextConfig });
      ...
      function e7(e10) {
        ...
        if (t2.startsWith("/_next") || t2.startsWith("/api") || t2.startsWith("/models") || t2.startsWith("/Studio_template") || t2.startsWith("/examples") || t2.startsWith("/stitch") || t2.startsWith("/templates") || t2.includes(".") || "/favicon.ico" === t2) return $.next();
        if (t2.startsWith("/admin")) {
          let t3 = process.env.ADMIN_SECRET;
          if (t3) {
            let r2 = e10.headers.get("authorization");
            if (r2) {
              let [, e11] = atob(r2.split(" ")[1]).split(":");
              if (e11 === t3) return $.next();
            }
            return new $("Authentication required", { status: 401, headers: { "WWW-Authenticate": 'Basic realm="Secure Area"' } });
          }
          return $.next();
        }
        if (!("/" === t2 || "/studio" === t2 || t2.startsWith("/merci"))) {
          let t3 = e10.nextUrl.clone();
          return t3.pathname = "/studio", $.redirect(t3);
        }
        return $.next();
      }
      RegExp(`\\n\\s+at __next_metadata_boundary__[\\n\\s]`), RegExp(`\\n\\s+at __next_viewport_boundary__[\\n\\s]`), RegExp(`\\n\\s+at __next_outlet_boundary__[\\n\\s]`), /* @__PURE__ */ new WeakMap();
      let e8 = { matcher: ["/((?!_next/static|_next/image|favicon.ico).*)"] };
...
var NextConfig = { "env": {}, "webpack": null, "eslint": { "ignoreDuringBuilds": false }, "typescript": { "ignoreBuildErrors": false, "tsconfigPath": "tsconfig.json" }, "distDir": ".next", "cleanDistDir": true, "assetPrefix": "", "cacheMaxMemorySize": 52428800, "configOrigin": "next.config.ts", "useFileSystemPublicRoutes": true, "generateEtags": true, "pageExtensions": ["tsx", "ts", "jsx", "js"], "poweredByHeader": true, "compress": true, "images": { "deviceSizes": [640, 750, 828, 1080, 1200, 1920, 2048, 3840], "imageSizes": [16, 32, 48, 64, 96, 128, 256, 384], "path": "/_next/image", "loader": "default", "loaderFile": "", "domains": [], "disableStaticImages": false, "minimumCacheTTL": 60, "formats": ["image/webp"], "dangerouslyAllowSVG": false, "contentSecurityPolicy": "script-src 'none'; frame-src 'none'; sandbox;", "contentDispositionType": "attachment", "remotePatterns": [], "unoptimized": false }, "devIndicators": { "position": "bottom-left" }, "onDemandEntries": { "maxInactiveAge": 6e4, "pagesBufferLength": 5 }, "amp": { "canonicalBase": "" }, "basePath": "", "sassOptions": {}, "trailingSlash": false, "i18n": null, "productionBrowserSourceMaps": false, "excludeDefaultMomentLocales": true, "serverRuntimeConfig": {}, "publicRuntimeConfig": {}, "reactProductionProfiling": false, "reactStrictMode": null, "reactMaxHeadersLength": 6e3, "httpAgentOptions": { "keepAlive": true }, "logging": {}, "expireTime": 31536e3, "staticPageGenerationTimeout": 60, "output": "standalone", "modularizeImports": { "@mui/icons-material": { "transform": "@mui/icons-material/{{member}}" }, "lodash": { "transform": "lodash/{{member}}" } }, "outputFileTracingRoot": "/Users/stephen/Desktop/DEKSTOP FILES/STEPHEN/APPLICATION/LEAD MAGNET/fashionai", "experimental": { "nodeMiddleware": false, "cacheLife": { "default": { "stale": 300, "revalidate": 900, "expire": 4294967294 }, "seconds": { "stale": 0, "revalidate": 1, "expire": 60 }, "minutes": { "stale": 300, "revalidate": 60, "expire": 3600 }, "hours": { "stale": 300, "revalidate": 3600, "expire": 86400 }, "days": { "stale": 300, "revalidate": 86400, "expire": 604800 }, "weeks": { "stale": 300, "revalidate": 604800, "expire": 2592e3 }, "max": { "stale": 300, "revalidate": 2592e3, "expire": 4294967294 } }, "cacheHandlers": {}, "cssChunking": true, "multiZoneDraftMode": false, "appNavFailHandling": false, "prerenderEarlyExit": true, "serverMinification": true, "serverSourceMaps": false, "linkNoTouchStart": false, "caseSensitiveRoutes": false, "clientSegmentCache": false, "preloadEntriesOnStart": true, "clientRouterFilter": true, "clientRouterFilterRedirects": false, "fetchCacheKeyPrefix": "", "middlewarePrefetch": "flexible", "optimisticClientCache": true, "manualClientBasePath": false, "cpus": 13, "memoryBasedWorkersCount": false, "imgOptConcurrency": null, "imgOptTimeoutInSeconds": 7, "imgOptMaxInputPixels": 268402689, "imgOptSequentialRead": null, "isrFlushToDisk": true, "workerThreads": false, "optimizeCss": false, "nextScriptWorkers": false, "scrollRestoration": false, "externalDir": false, "disableOptimizedLoading": false, "gzipSize": true, "craCompat": false, "esmExternals": true, "fullySpecified": false, "swcTraceProfiling": false, "forceSwcTransforms": false, "largePageDataBytes": 128e3, "turbo": { "root": "/Users/stephen/Desktop/DEKSTOP FILES/STEPHEN/APPLICATION/LEAD MAGNET/fashionai" }, "typedRoutes": false, "typedEnv": false, "parallelServerCompiles": false, "parallelServerBuildTraces": false, "ppr": false, "authInterrupts": false, "webpackMemoryOptimizations": false, "optimizeServerReact": true, "useEarlyImport": false, "viewTransition": false, "staleTimes": { "dynamic": 0, "static": 300 }, "serverComponentsHmrCache": true, "staticGenerationMaxConcurrency": 8, "staticGenerationMinPagesPerWorker": 25, "dynamicIO": false, "inlineCss": false, "useCache": false, "optimizePackageImports": ["lucide-react", "date-fns", "lodash-es", "ramda", "antd", "react-bootstrap", "ahooks", "@ant-design/icons", "@headlessui/react", "@headlessui-float/react", "@heroicons/react/20/solid", "@heroicons/react/24/solid", "@heroicons/react/24/outline", "@visx/visx", "@tremor/react", "rxjs", "@mui/material", "@mui/icons-material", "recharts", "react-use", "effect", "@effect/schema", "@effect/platform", "@effect/platform-node", "@effect/platform-browser", "@effect/platform-bun", "@effect/sql", "@effect/sql-mssql", "@effect/sql-mysql2", "@effect/sql-pg", "@effect/sql-squlite-node", "@effect/sql-squlite-bun", "@effect/sql-squlite-wasm", "@effect/sql-squlite-react-native", "@effect/rpc", "@effect/rpc-http", "@effect/typeclass", "@effect/experimental", "@effect/opentelemetry", "@material-ui/core", "@material-ui/icons", "@tabler/icons-react", "mui-core", "react-icons/ai", "react-icons/bi", "react-icons/bs", "react-icons/cg", "react-icons/ci", "react-icons/di", "react-icons/fa", "react-icons/fa6", "react-icons/fc", "react-icons/fi", "react-icons/gi", "react-icons/go", "react-icons/gr", "react-icons/hi", "react-icons/hi2", "react-icons/im", "react-icons/io", "react-icons/io5", "react-icons/lia", "react-icons/lib", "react-icons/lu", "react-icons/md", "react-icons/pi", "react-icons/ri", "react-icons/rx", "react-icons/si", "react-icons/sl", "react-icons/tb", "react-icons/tfi", "react-icons/ti", "react-icons/vsc", "react-icons/wi"], "trustHostHeader": false, "isExperimentalCompile": false }, "htmlLimitedBots": "Mediapartners-Google|Slurp|DuckDuckBot|baiduspider|yandex|sogou|bitlybot|tumblr|vkShare|quora link preview|redditbot|ia_archiver|Bingbot|BingPreview|applebot|facebookexternalhit|facebookcatalog|Twitterbot|LinkedInBot|Slackbot|Discordbot|WhatsApp|SkypeUriPreview", "bundlePagesRouterDependencies": false, "configFileName": "next.config.ts" };
var BuildId = "xQOhNY_fJzN7wsZRdJnrX";
var RoutesManifest = { "basePath": "", "rewrites": { "beforeFiles": [], "afterFiles": [], "fallback": [] }, "redirects": [{ "source": "/:path+/", "destination": "/:path+", "internal": true, "statusCode": 308, "regex": "^(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))/$" }], "routes": { "static": [{ "page": "/", "regex": "^/(?:/)?$", "routeKeys": {}, "namedRegex": "^/(?:/)?$" }, { "page": "/_not-found", "regex": "^/_not\\-found(?:/)?$", "routeKeys": {}, "namedRegex": "^/_not\\-found(?:/)?$" }, { "page": "/admin", "regex": "^/admin(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin(?:/)?$" }, { "page": "/admin/leads", "regex": "^/admin/leads(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/leads(?:/)?$" }, { "page": "/admin/test-pipeline", "regex": "^/admin/test\\-pipeline(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/test\\-pipeline(?:/)?$" }, { "page": "/favicon.ico", "regex": "^/favicon\\.ico(?:/)?$", "routeKeys": {}, "namedRegex": "^/favicon\\.ico(?:/)?$" }, { "page": "/kits", "regex": "^/kits(?:/)?$", "routeKeys": {}, "namedRegex": "^/kits(?:/)?$" }, { "page": "/studio", "regex": "^/studio(?:/)?$", "routeKeys": {}, "namedRegex": "^/studio(?:/)?$" }], "dynamic": [{ "page": "/api/dl/[token]", "regex": "^/api/dl/([^/]+?)(?:/)?$", "routeKeys": { "nxtPtoken": "nxtPtoken" }, "namedRegex": "^/api/dl/(?<nxtPtoken>[^/]+?)(?:/)?$" }, { "page": "/kits/[slug]", "regex": "^/kits/([^/]+?)(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/kits/(?<nxtPslug>[^/]+?)(?:/)?$" }, { "page": "/merci/[slug]", "regex": "^/merci/([^/]+?)(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/merci/(?<nxtPslug>[^/]+?)(?:/)?$" }], "data": { "static": [], "dynamic": [] } }, "locales": [] };
var ConfigHeaders = [];
var PrerenderManifest = { "version": 4, "routes": { "/favicon.ico": { "initialHeaders": { "cache-control": "public, max-age=0, must-revalidate", "content-type": "image/x-icon", "x-next-cache-tags": "_N_T_/layout,_N_T_/favicon.ico/layout,_N_T_/favicon.ico/route,_N_T_/favicon.ico" }, "experimentalBypassFor": [{ "type": "header", "key": "Next-Action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/favicon.ico", "dataRoute": null, "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/kits": { "experimentalBypassFor": [{ "type": "header", "key": "Next-Action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/kits", "dataRoute": "/kits.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/admin/leads": { "experimentalBypassFor": [{ "type": "header", "key": "Next-Action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/admin/leads", "dataRoute": "/admin/leads.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/studio": { "experimentalBypassFor": [{ "type": "header", "key": "Next-Action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/studio", "dataRoute": "/studio.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/": { "experimentalBypassFor": [{ "type": "header", "key": "Next-Action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/", "dataRoute": "/index.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/admin/test-pipeline": { "experimentalBypassFor": [{ "type": "header", "key": "Next-Action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/admin/test-pipeline", "dataRoute": "/admin/test-pipeline.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/admin": { "experimentalBypassFor": [{ "type": "header", "key": "Next-Action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/admin", "dataRoute": "/admin.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] } }, "dynamicRoutes": {}, "notFoundRoutes": [], "preview": { "previewModeId": "32551b622bd520713edabd975530853e", "previewModeSigningKey": "4d56edd018d4ac004490358f52d64783f2ae284a8ba299f91ff2d46a68c536bc", "previewModeEncryptionKey": "9b02d6c95b42f07e8869ef013929f580a216e50b03564ac3ac6237297b126812" } };
var MiddlewareManifest = { "version": 3, "middleware": { "/": { "files": ["server/edge-runtime-webpack.js", "server/src/middleware.js"], "name": "src/middleware", "page": "/", "matchers": [{ "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/((?!_next\\/static|_next\\/image|favicon.ico).*))(\\.json)?[\\/#\\?]?$", "originalSource": "/((?!_next/static|_next/image|favicon.ico).*)" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "xQOhNY_fJzN7wsZRdJnrX", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "LnemV2nh8iaRBEy8mIWBOkde8NffLYb3KA6411Z9xLU=", "__NEXT_PREVIEW_MODE_ID": "32551b622bd520713edabd975530853e", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "9b02d6c95b42f07e8869ef013929f580a216e50b03564ac3ac6237297b126812", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "4d56edd018d4ac004490358f52d64783f2ae284a8ba299f91ff2d46a68c536bc" } } }, "functions": {}, "sortedMiddleware": ["/"] };
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/api/admin/test-pipeline/route": "/api/admin/test-pipeline", "/api/shoots/route": "/api/shoots", "/api/dl/[token]/route": "/api/dl/[token]", "/favicon.ico/route": "/favicon.ico", "/admin/page": "/admin", "/admin/test-pipeline/page": "/admin/test-pipeline", "/admin/leads/page": "/admin/leads", "/kits/[slug]/page": "/kits/[slug]", "/kits/page": "/kits", "/merci/[slug]/page": "/merci/[slug]", "/page": "/", "/studio/page": "/studio" };
